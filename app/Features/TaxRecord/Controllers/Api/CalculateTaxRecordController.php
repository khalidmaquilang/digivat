...
class CalculateTaxRecordController extends ApiController
{
    ...
    #[BodyParameter(name: 'order_discount', description: 'The discount amount in centavos applied to the order. Must be greater than or equal to 0. Defaults to 0.', required: false, type: 'number', example: 200)]
